/* 
 * This code was written by greathat
 */
...
int main(){
    TESTCASE{
        ...
        int needzero = (k+1) /2;
        int needone = k /2 ;
        int needzeros = needzero + 1;
        int needones = needone + 1;

        for (int i = 0;i<needzeros;i++){
          ans += "0";
        }
        for(int i = 0 ;i<needones;i++){
          ans += "1";
        }
         max_zero = max_zero - needzeros;
         max_one = max_one - needones;
        
        while(max_zero > 0 && max_one > 0){
          ans = "01" + ans;
          max_zero --;
          max_one --;
        }
